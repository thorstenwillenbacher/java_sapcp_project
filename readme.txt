...
Runtime    : Java EE 7 Web Profile TomEE 7
Version    : 1.21.13
...
(2) As a prerequisite you will have to create a server runtime environment called "Java EE 7 Web Profile TomEE 7".
You can do so through the menu: Window->Preferences->Server->Runtime Environment->Add...->SAP->Java EE 7 Web Profile TomEE 7...
If you imported a sample not having done the above you will have an error: "Faceted Project Problem: Target runtime Java EE 7 Web Profile TomEE 7 is not defined".
